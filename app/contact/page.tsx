    ...
    <>
      ...
      <section className="bg-page-bg py-24">
        <div className="max-w-[75rem] mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Right: Tally Form Placeholder */}
          <div className="bg-white border border-ivory-200 rounded-lg p-8 min-h-[400px] flex items-center justify-center text-center">
            <div>
              ...
              {/* <iframe data-tally-src="https://tally.so/embed/wQ7yBn?alignLeft=1&hideTitle=1&transparentBackground=1" width="100%" height="500" frameBorder="0" title="Contact Form"></iframe> */}
            </div>
          </div>
        </div>
      </section>
